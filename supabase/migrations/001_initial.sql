-- ============================================================
-- Event Booking Platform — Run this in Supabase SQL Editor
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_event ON whatsapp_messages(event_id, created_at);

-- Seed equipment
INSERT INTO equipment (name, type, description, quantity_available, hourly_rate, daily_rate) VALUES
...
CREATE POLICY "Public can insert client details" ON client_details FOR INSERT WITH CHECK (true);
CREATE POLICY "Public can view client details" ON client_details FOR SELECT USING (true);
...
CREATE POLICY "Public can insert whatsapp messages" ON whatsapp_messages FOR INSERT WITH CHECK (true);
CREATE POLICY "Public can view whatsapp messages" ON whatsapp_messages FOR SELECT USING (true);
